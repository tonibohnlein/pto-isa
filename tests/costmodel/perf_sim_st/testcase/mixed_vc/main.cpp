...
void vc_bm128_n128_k128_t1() {
    ...
    MixedVC<0, 128, 128, 128, 1>(A, B, ap0, ap1, co);
}
void vc_bm128_n128_k128_t2() {
    static __gm__ half  *const A   = reinterpret_cast<__gm__ half  *>(0x10000000);
    static __gm__ half  *const B   = reinterpret_cast<__gm__ half  *>(0x20000000);
    static __gm__ half  *const ap0 = reinterpret_cast<__gm__ half  *>(0x50000000);
    static __gm__ half  *const ap1 = reinterpret_cast<__gm__ half  *>(0x54000000);
    static __gm__ float *const co  = reinterpret_cast<__gm__ float *>(0x30000000);
    MixedVC<0, 128, 128, 128, 2>(A, B, ap0, ap1, co);
}
void vc_bm128_n128_k128_t4() {
    static __gm__ half  *const A   = reinterpret_cast<__gm__ half  *>(0x10000000);
    static __gm__ half  *const B   = reinterpret_cast<__gm__ half  *>(0x20000000);
    static __gm__ half  *const ap0 = reinterpret_cast<__gm__ half  *>(0x50000000);
    static __gm__ half  *const ap1 = reinterpret_cast<__gm__ half  *>(0x54000000);
    static __gm__ float *const co  = reinterpret_cast<__gm__ float *>(0x30000000);
    MixedVC<0, 128, 128, 128, 4>(A, B, ap0, ap1, co);
}
void vc_bm128_n128_k128_t8() {
    static __gm__ half  *const A   = reinterpret_cast<__gm__ half  *>(0x10000000);
    static __gm__ half  *const B   = reinterpret_cast<__gm__ half  *>(0x20000000);
    static __gm__ half  *const ap0 = reinterpret_cast<__gm__ half  *>(0x50000000);
    static __gm__ half  *const ap1 = reinterpret_cast<__gm__ half  *>(0x54000000);
    static __gm__ float *const co  = reinterpret_cast<__gm__ float *>(0x30000000);
    MixedVC<0, 128, 128, 128, 8>(A, B, ap0, ap1, co);
}

TEST(MixedVc, All) {
    LAUNCH_KERNEL(vc_bm128_n128_k128_t1, , (1, nullptr, nullptr));
    LAUNCH_KERNEL(vc_bm128_n128_k128_t2, , (1, nullptr, nullptr));
    LAUNCH_KERNEL(vc_bm128_n128_k128_t4, , (1, nullptr, nullptr));
    LAUNCH_KERNEL(vc_bm128_n128_k128_t8, , (1, nullptr, nullptr));
}
