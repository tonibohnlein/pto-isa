...
void mxc_un_1() {
    auto _m = pto::mocker::evaluator::MakeFlatHillModel();
    _m.total_read_gibs = 0.0;          // 0 => uncapped (flat baseline); 900 => shared pool
    pto::mocker::evaluator::SetHillBandwidthModel(_m);
    ...
    MixedOverlap<0, 128, 32, 128, 4>(A, B, b0, b1);
}
void mxc_cap_1() {
    auto _m = pto::mocker::evaluator::MakeFlatHillModel();
    _m.total_read_gibs = 900.0;          // 0 => uncapped (flat baseline); 900 => shared pool
    pto::mocker::evaluator::SetHillBandwidthModel(_m);
    static __gm__ half  *const A  = reinterpret_cast<__gm__ half  *>(0x10000000);
    static __gm__ half  *const B  = reinterpret_cast<__gm__ half  *>(0x20000000);
    static __gm__ float *const b0 = reinterpret_cast<__gm__ float *>(0x30000000);
...
TEST(MixedContention, All) {
    LAUNCH_KERNEL(mxc_un_1, , (1, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_cap_1, , (1, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_un_2, , (2, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_cap_2, , (2, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_un_4, , (4, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_cap_4, , (4, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_un_8, , (8, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_cap_8, , (8, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_un_16, , (16, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_cap_16, , (16, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_un_24, , (24, nullptr, nullptr));
    LAUNCH_KERNEL(mxc_cap_24, , (24, nullptr, nullptr));
}
